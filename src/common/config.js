...
const configDir =
  argv["c"] || argv["config"] || path.join(home, ".config/room-presence")
...
function configFromFile() {
  try {
    ...
    console.error(
      "Could not read config at " + path.join(configDir, "config.json"),
    )
    return {}
  }
}

const penultimateConfig = Object.assign({}, defaultConfig, configFromFile(), {
  machineId: machineId,
})
